          ...
          <div className="chart-container">
            <div className="pie-chart">
              <div className="pie-chart-container">
                <div className="pie-segment men" style={{ "--percentage": "45%" }}></div>
                <div className="pie-segment women" style={{ "--percentage": "35%" }}></div>
                <div className="pie-segment accessories" style={{ "--percentage": "15%" }}></div>
                <div className="pie-segment other" style={{ "--percentage": "5%" }}></div>
              </div>
            </div>
          </div>
